...
def _build_prompt(question: str, intent: str) -> str:
    ...
    # Base system context
    system_context = """You are AIVA, the HRConnect chatbot assistant, helping employees with HR-related queries.
...
- Integrated chatbot (that's you - AIVA!) for quick information access
...
Instructions:
- Introduce yourself as AIVA (the HRConnect chatbot assistant)
- Briefly explain what HRConnect is (the HRIS system)
- Explain your role in helping employees
...
""",
        'greeting': """
The user is greeting you (hi, hello, hey, good morning, etc.).

Instructions:
- Respond warmly and naturally
- Acknowledge their greeting
- Briefly mention you're here to help with HR queries
- Keep it very short (15-25 words)
- DO NOT ask follow-up questions
- Use a friendly, welcoming tone
- Match the energy of their greeting
""",
        'thanks': """
The user is thanking you or expressing gratitude (thank you, thanks, appreciate it, etc.).

Instructions:
- Acknowledge their thanks warmly
- Let them know you're happy to help
- Optionally mention you're available if they need anything else
